...
class TableController extends Controller
{
    ...
    {
        $data=DataUser::whereNotIn('namauser',['superuser','admin']);
        $result = Datatables::of($data);
        ...
        $result->addColumn('action', function ($data) {
            ...
            <i class="fa fa-cog"> &nbsp; <i class="fa fa-caret-down"></i></i></a>
            <ul class="dropdown-menu">
            <li><a href="javascript:;" data-type="user" data-ref="'.Crypt::encryptstring($data->id_usr.'&20tekNo17').'" class="btn-edit"><i class="fa fa-pencil"></i> Edit </a></li>
            <li><a href="javascript:;" data-type="user" data-ref="'.Crypt::encryptstring($data->id_usr.'&20tekNo17').'" class="btn-delete"><i class="fa fa-trash-o delete-tag"></i> Delete </a></li>
            </ul>
            </div>
            </div>
            ';
